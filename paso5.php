 ...
 */
    ...
    <div class="container">
        ...
        <div class="chart-skills">
            <div id="fondo"><img src="img/Pasos/Navegador-P5.png" style="width: 100px;height:100px;"></div>
        ...
        <div class="cuadro2">
            ...
            <ul class="cuadro2">
                <li><a href="buscar.php" style="font-family:Fira Sans Condensed, sans-serif ;font-size:14px;font-weight: lighter;color:white;" target="_blank">Buscador de estrategias </a></li><br>
