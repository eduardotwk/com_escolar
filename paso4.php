 ...
 */
    ...
    <div class="container">
        ...
        <div class="cuadro2">
            ...
            <ul class="cuadro2">
                <li><a href="buscar.php" style="font-family:Fira Sans Condensed, sans-serif ;font-size:14px;font-weight: lighter;color:white;" target="_blank">Buscador de estrategias </a></li>
