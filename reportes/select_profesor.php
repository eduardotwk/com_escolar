...
if (isset($_SESSION['user'])) {
    ...
    <body class="hold-transition skin-blue sidebar-mini" style="background: #BDC3C7; min-height: 100vh;">
                        ...
                        <tr width="100%">
                            ...
                            <td align="right" width="50%">
                                <button id="btn_cerrar_session"
                                    ...
                                    <img id="img_btn_salir" style="width: 128px; height: 48px; "
                                         src="../assets/img/salir-2.png">
                                </button>
                            </td>
                        </tr>
                    </table>
                ...
                <div id="curso_p" style="display: none;">
                    ...
                    <div class="content-wrapper">
                        <section class="content-header"
                                 style="background: #f4af1f; display: flex; justify-content: center; text-align: center;">
                            <a style="width: 60px; height: 60px; border: 0; color: white; background: #f4af1f; padding: 0; font-size: 30px;"
                               class="openbtn btn_side">☰</a>
                            <ul class="nav nav-pills"
                                style="margin-top: 37px; display: flex; justify-content: flex-start; text-align: left;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div id="selector_anio" class="col-xs-6">
                                                ...
                                                <select onchange="profe_anio_seleccion(this)" name="select_anio_profe"
                                                        id="select_anio_profe" class="form-control">
                                                    <?php
    ...
    <footer class="page-footer pt-4"
            style="margin-bottom: 0px; background: white; padding-top: 40px; padding-bottom: 0px; bottom: 0; height: 200px;">
                ...
                <tr>
                    <td align="left" valign="center">
                        <div style="display: flex; align-items: baseline;">
                            ...
                            <img style="margin-right: 5px; padding-bottom: 4px;" width="100"
                                 src="../assets/img/autonoma.png">
                    ...
                    <td width="33%" align="center" valign="center">
                        <p style="font-size: small; text-align: justify; font: condensed 100% sans-serif; color: #212529;">
                            Estas encuestas forman parte del Proyecto FONDEF ID14I10078-ID14I20078 Medición del
                            compromiso del niño, niña y adolescente con sus estudios para la promoción de trayectorias
                            educativas exitosas.
                        </p>
                    </td>
                </tr>
