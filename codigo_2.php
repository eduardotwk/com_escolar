            ...
            <div class="container">
                <div class="row">    
                         ...
                         <div class="col-md-3 col-6 text-center">
                           <a href='reportes/login' target="_parent" class="btn btn-primary mt-1  mb-1 hvr-grow  text-white">Reportes y administración <i class="fa fa-pie-chart" aria-hidden="true"></i></a>                         
                         </div>

                         <div class="col-md-2 col-6 text-center">
                           <a href='material' target="_parent" class="btn btn-primary mt-1 mb-1 hvr-grow text-white">Material de Apoyo <i class="fa fa-lightbulb-o" aria-hidden="true"></i></a>
                         </div>
