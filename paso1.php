...
<body>
    ...
    <div class="container">
        ...
        <div class="panel2" style="max-height: 686px;">
        ...
        <div class="cuadro2">
            ...
            <p class="cuadro2"><a style="font-family:Open Sans,sans-serif ;font-size:18px;font-weight: lighter;color:white;" href="https://www.e-mineduc.cl/login/index.php">Módulo de Capacitación</p>
            <img class="cap2" src="img/menu_flotante/1.-Capacitacion.png">
        </div>
    </div>
