 ...
 */
    ...
    <div class="container">
        ...
        <div class="chart-skills">
            <div id="fondo"><img src="img/Pasos/Navegador-P3.png" style="width: 100px;height:100px;"></div>
        ...
        <div class="cuadro2">
            ...
            <ul class="cuadro2">
                ...
                <li>
                    <a href="/inicia_reportes.php" target="_blank" style="font-family:Fira Sans Condensed, sans-serif ;font-size:14px;font-weight: lighter;color:white;">
                        <image src="img/menu_flotante/6.-Resultados.png" style="width:30px;height: 30px;position:absolute;top:28px;right:95%">
                            Resultados de la medición del Compromiso Escolar
                    </a>
                </li>
            </ul>
        </div>
