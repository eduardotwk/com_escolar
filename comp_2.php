...
<body>
    ...
    <li><a href="#">Compromiso Escolar</a></li>
    ...
    <div class="container">
        ...
        <p class="p1">
            Uno de los elementos centrales del SIESE es la medición del <strong>Compromiso Escolar</strong>, variable clave para prevenir la desescolarización, debido a que la decisión de abandonar la escuela es la etapa final de un proceso de pérdida paulatina del interés por los estudios.
